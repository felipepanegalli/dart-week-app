...
import 'package:dart_week_app/app/repositories/categorias_repository.dart';
...
abstract class _CadastrarMovimentacaoControllerBase with Store {
  ...
  CategoryRepository _categoriaRepository = Modular.get<CategoryRepository>();
  ...
  Future<void> buscarCategorias(String tipo) async {
    try {
      ...
      _categoriasFuture =
          ObservableFuture(_categoriaRepository.getCategoria(tipo));
